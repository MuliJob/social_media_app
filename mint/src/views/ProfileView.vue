        ...
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                ...
                <div class="mt-6">
                    ...
                    <button 
                        class="inline-block mt-4 py-4 px-3 bg-emerald-600 text-xs text-white rounded-lg" 
                    ...
                    <RouterLink 
                        class="inline-block mr-2 py-4 px-3 bg-emerald-600 text-xs text-white rounded-lg" 
                        to="/profile/edit"
                        v-if="userStore.user.id === user.id"
                    >
                        Edit profile
